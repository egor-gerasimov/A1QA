...
public class HomePage {
    ...
    public void clickCatalog() {
        WebElement buttonCatalog = Waits.implicitWait(BUTTON_CATALOG_1, BUTTON_CATALOG_2);
        buttonCatalog.click();
    }
    ...
    public boolean isLoggedIn() {
        Waits.explicitWaitLocated(BUTTON_PROFILE);
        return true;
    }

    public boolean isLoggedOut() {
        Waits.explicitWaitLocated(BUTTON_LOGIN);
        return true;
    }
